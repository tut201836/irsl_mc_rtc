...
if(NOT force_control_collection_FOUND)
  set(skip_this_file FALSE)
endif()
if(skip_this_file)
  foreach(component ${force_control_collection_FIND_COMPONENTS})
    if(NOT "force_control_collection_${component}_FOUND")
      set(skip_this_file FALSE)
    endif()
  endforeach()
endif()
...
set("force_control_collection_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("FORCE_CONTROL_COLLECTION_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("force_control_collection_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/force_control_collection/doxygen-html")
set("FORCE_CONTROL_COLLECTION_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/force_control_collection/doxygen-html")
set("force_control_collection_DEPENDENCIES" "mc_rtc")
set("force_control_collection_PKG_CONFIG_DEPENDENCIES" "")
...
set("_force_control_collection_PKG_CONFIG_LIBDIR" "/mc_rtc_ws/install/lib")
set("_force_control_collection_PKG_CONFIG_LIBS_LIST" "")
if(_force_control_collection_PKG_CONFIG_LIBS_LIST)
  string(FIND ${_force_control_collection_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  while(_is_comma_space GREATER -1)
    string(REPLACE ", " "," _force_control_collection_PKG_CONFIG_LIBS_LIST "${_force_control_collection_PKG_CONFIG_LIBS_LIST}")
    string(FIND ${_force_control_collection_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  endwhile()
  string(REPLACE " " ";" _force_control_collection_PKG_CONFIG_LIBS_LIST "${_force_control_collection_PKG_CONFIG_LIBS_LIST}")
  set(LIBDIR_HINTS ${_force_control_collection_PKG_CONFIG_LIBDIR})
  foreach(component ${_force_control_collection_PKG_CONFIG_LIBS_LIST})
  ...
  endforeach()
endif(_force_control_collection_PKG_CONFIG_LIBS_LIST)

set("force_control_collection_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
set("FORCE_CONTROL_COLLECTION_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
...
IF(COMMAND ADD_REQUIRED_DEPENDENCY)
  FOREACH(pkgcfg_dep ${force_control_collection_PKG_CONFIG_DEPENDENCIES})
...
include("${CMAKE_CURRENT_LIST_DIR}/force_control_collectionTargets.cmake")
...
foreach(component ${force_control_collection_FIND_COMPONENTS})
  ...
  if(EXISTS ${comp_file})
    ...
    set(force_control_collection_${component}_FOUND FALSE)
  endif()
  if(force_control_collection_${component}_FOUND)
    message(STATUS "force_control_collection: ${component} found.")
  else()
    message(STATUS "force_control_collection: ${component} not found.")
  endif()
endforeach()
check_required_components("force_control_collection")

...
if(NOT centroidal_control_collection_FOUND)
  set(skip_this_file FALSE)
endif()
if(skip_this_file)
  foreach(component ${centroidal_control_collection_FIND_COMPONENTS})
    if(NOT "centroidal_control_collection_${component}_FOUND")
      set(skip_this_file FALSE)
    endif()
  endforeach()
endif()
...
set("centroidal_control_collection_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("CENTROIDAL_CONTROL_COLLECTION_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("centroidal_control_collection_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/centroidal_control_collection/doxygen-html")
set("CENTROIDAL_CONTROL_COLLECTION_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/centroidal_control_collection/doxygen-html")
set("centroidal_control_collection_DEPENDENCIES" "mc_rtc")
set("centroidal_control_collection_PKG_CONFIG_DEPENDENCIES" "")
...
set("_centroidal_control_collection_PKG_CONFIG_LIBDIR" "/mc_rtc_ws/install/lib")
set("_centroidal_control_collection_PKG_CONFIG_LIBS_LIST" "")
if(_centroidal_control_collection_PKG_CONFIG_LIBS_LIST)
  string(FIND ${_centroidal_control_collection_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  while(_is_comma_space GREATER -1)
    string(REPLACE ", " "," _centroidal_control_collection_PKG_CONFIG_LIBS_LIST "${_centroidal_control_collection_PKG_CONFIG_LIBS_LIST}")
    string(FIND ${_centroidal_control_collection_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  endwhile()
  string(REPLACE " " ";" _centroidal_control_collection_PKG_CONFIG_LIBS_LIST "${_centroidal_control_collection_PKG_CONFIG_LIBS_LIST}")
  set(LIBDIR_HINTS ${_centroidal_control_collection_PKG_CONFIG_LIBDIR})
  foreach(component ${_centroidal_control_collection_PKG_CONFIG_LIBS_LIST})
  ...
  endforeach()
endif(_centroidal_control_collection_PKG_CONFIG_LIBS_LIST)

set("centroidal_control_collection_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
set("CENTROIDAL_CONTROL_COLLECTION_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
...
IF(COMMAND ADD_REQUIRED_DEPENDENCY)
  FOREACH(pkgcfg_dep ${centroidal_control_collection_PKG_CONFIG_DEPENDENCIES})
...
include("${CMAKE_CURRENT_LIST_DIR}/centroidal_control_collectionTargets.cmake")
...
foreach(component ${centroidal_control_collection_FIND_COMPONENTS})
  ...
  if(EXISTS ${comp_file})
    ...
    set(centroidal_control_collection_${component}_FOUND FALSE)
  endif()
  if(centroidal_control_collection_${component}_FOUND)
    message(STATUS "centroidal_control_collection: ${component} found.")
  else()
    message(STATUS "centroidal_control_collection: ${component} not found.")
  endif()
endforeach()
check_required_components("centroidal_control_collection")

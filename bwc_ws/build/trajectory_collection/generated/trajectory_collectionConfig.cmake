...
if(NOT trajectory_collection_FOUND)
  set(skip_this_file FALSE)
endif()
if(skip_this_file)
  foreach(component ${trajectory_collection_FIND_COMPONENTS})
    if(NOT "trajectory_collection_${component}_FOUND")
      set(skip_this_file FALSE)
    endif()
  endforeach()
endif()
...
set("trajectory_collection_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("TRAJECTORY_COLLECTION_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("trajectory_collection_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/trajectory_collection/doxygen-html")
set("TRAJECTORY_COLLECTION_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/trajectory_collection/doxygen-html")
set("trajectory_collection_DEPENDENCIES" "SpaceVecAlg")
set("trajectory_collection_PKG_CONFIG_DEPENDENCIES" "")
...
set("_trajectory_collection_PKG_CONFIG_LIBDIR" "${pcfiledir}/../../lib")
set("_trajectory_collection_PKG_CONFIG_LIBS_LIST" "")
if(_trajectory_collection_PKG_CONFIG_LIBS_LIST)
  string(FIND ${_trajectory_collection_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  while(_is_comma_space GREATER -1)
    string(REPLACE ", " "," _trajectory_collection_PKG_CONFIG_LIBS_LIST "${_trajectory_collection_PKG_CONFIG_LIBS_LIST}")
    string(FIND ${_trajectory_collection_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  endwhile()
  string(REPLACE " " ";" _trajectory_collection_PKG_CONFIG_LIBS_LIST "${_trajectory_collection_PKG_CONFIG_LIBS_LIST}")
  set(LIBDIR_HINTS ${_trajectory_collection_PKG_CONFIG_LIBDIR})
  foreach(component ${_trajectory_collection_PKG_CONFIG_LIBS_LIST})
  ...
  endforeach()
endif(_trajectory_collection_PKG_CONFIG_LIBS_LIST)

set("trajectory_collection_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
set("TRAJECTORY_COLLECTION_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
...
if(${CMAKE_VERSION} VERSION_LESS "3.15.0")
  ...
  find_dependency(SpaceVecAlg REQUIRED)
endif()

IF(COMMAND ADD_REQUIRED_DEPENDENCY)
  FOREACH(pkgcfg_dep ${trajectory_collection_PKG_CONFIG_DEPENDENCIES})
...
include("${CMAKE_CURRENT_LIST_DIR}/trajectory_collectionTargets.cmake")
...
foreach(component ${trajectory_collection_FIND_COMPONENTS})
  ...
  if(EXISTS ${comp_file})
    ...
    set(trajectory_collection_${component}_FOUND FALSE)
  endif()
  if(trajectory_collection_${component}_FOUND)
    message(STATUS "trajectory_collection: ${component} found.")
  else()
    message(STATUS "trajectory_collection: ${component} not found.")
  endif()
endforeach()
check_required_components("trajectory_collection")

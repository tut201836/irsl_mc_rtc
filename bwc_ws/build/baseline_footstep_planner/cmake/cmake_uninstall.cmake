...
IF(NOT EXISTS "/bwc_ws/build/baseline_footstep_planner/install_manifest.txt")
  RETURN()
ENDIF(NOT EXISTS "/bwc_ws/build/baseline_footstep_planner/install_manifest.txt")
...
IF(EXISTS "/install_manifest.txt")
  return()
ENDIF()
FILE(READ "/bwc_ws/build/baseline_footstep_planner/install_manifest.txt" files)
...
ENDFOREACH(file)
EXECUTE_PROCESS(
  COMMAND "/usr/bin/cmake" -E remove "/bwc_ws/build/baseline_footstep_planner/install_manifest.txt"
  RESULT_VARIABLE rm_resval
  OUTPUT_VARIABLE rm_out
  ERROR_QUIET
  )

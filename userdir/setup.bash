...
SOURCE_FILE="bwc/BaselineWalkingController.yaml"
cp "$SOURCE_FILE" "$DEST_DIR"

# copy chidori.yaml
DEST_DIR="/mc_rtc_ws/src/mc_chidori/etc/BaselineWalkingController/chidori.yaml"
SOURCE_FILE="bwc/chidori.yaml"
cp "$SOURCE_FILE" "$DEST_DIR"

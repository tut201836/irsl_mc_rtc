...
def create_joint(i, joint_width):
    """ジョイントデータを生成する"""
    ...
    joint = {
        ...
        "joint_id": i,
        "joint_range": [-math.radians(30), math.radians(30)],  # 傾きの範囲を30度に設定
...
def generate_choreonoid_body(x_joint_count, joint_width, K, D):
    ...
    for i in range(x_joint_count):
        joint = create_joint(i, joint_width)
...
def main():
    ...
    body_data, spring_settings = generate_choreonoid_body(x_joint_count, joint_width, K, D)
